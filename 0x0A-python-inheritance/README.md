# Inheritance
Project done during **Full Stack Software Engineering studies** at **ALX SWE**. It aims to learn about inheritance, superclass, baseclass and subclass in **Python**.

## Technologies
* Python Scripts are written with Python 5.1.17
