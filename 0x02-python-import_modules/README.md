# Import & modules
Project done during **Full Stack Software Engineering studies** at **ALX SWE**. It aims to learn how to import functions, how to create modules and how to use command line arguments in **Python**.

## Technologies
* Shell Scripts are written in Bash 5.0.17(1)
* Python Scripts are written with Python 3.5.10
