...
Project done during **Full Stack Software Engineering studies** at **ALX SWE**. It aims to learn about object oriented programming (OOP), Data Abstraction, Data Encapsulation, instances and classes attributes in **Python**.
